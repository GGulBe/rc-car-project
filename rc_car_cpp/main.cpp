...
int main() {
    try {
        ...
        while (true) {
            ...
            UartDevice::gpsdata = gps.parseRmc();
            std::cout << "gpsfix : " << UartDevice::gpsdata.gpsfix << "lat : " << UartDevice::gpsdata.lot <<  "lot : " << UartDevice::gpsdata.lat << "UTC : " << UartDevice::gpsdata.utc << "date : " << UartDevice::gpsdata.date << std::endl;
